...
$(function(){
	...
	obj = {
		...
		//增加信息
		add:function(){
			 var content = "<iframe src='addResume.html' id='context' name='context' width='100%' height='100%' frameborder='0' scrolling='no'></iframe>";
		        $('#dd').dialog({
		            content:content,
		            title: '增加个人简历条目',
		            width: 600,
		...
		edit:function(){
			...
			if(rows.length == 1){
				var jq = top.jQuery;    
				var url = 'updateResume.html?id='+rows[0].id;
	...
	$("#datagrid").datagrid({
		width:700,
		fit:true,
		url:'/ResumeController/paginationQuery',
		title:'个人简历',
		striped:true,
		rownumbers:true,
		fitColumns:true,
