...
$(function(){
	...
	$("#datagrid").datagrid({
		width:1000,
		fit:true,
		url:'/signUpController/paginationQueryActivity',
		title:'活动信息',
		striped:true,
		rownumbers:true,
		fitColumns:true,
		...
		columns:[[
			...
			{	
				...
				formatter :function(value, row, index) {
		            	return '<span><a href="javascript:void(0);" onclick="checkAct('+row.id+')">审核</a></span>';	//
				}
			},
		]],
		toolbar:'#tb',
	        	...
	        	$("#datagridatt").datagrid({
					...
					columns:[[
						...
						{	
							...
							align : 'center', 
							formatter :function(value, row, index) {
					            	return '<span><a href="/AttachmentUploadController/downloadAtt?name='+row.servername+'">下载</a></span>';	//onclick="downloadAtt('+row.id+')"
							}
						},
					]],
					toolbar:'#tb2',
